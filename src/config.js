...
export function loadConfig(env = process.env) {
  ...
  return { production, publicBaseUrl, allowedOrigins, sessionSecret, redirectUri, adminIds, sessionTtlMs: ttl * 1000, clientId, clientSecret, databasePath, host: env.HOST || '127.0.0.1', port };
}
